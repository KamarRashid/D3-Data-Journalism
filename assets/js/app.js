...
// Now we use xText to append the text SVG files, with y coordinates specified to space out the values - age.
xText
    .append("text")
    .attr("y", -26)
...
function visualize(theData) {
    ...
    // We append the axes in group elements. By calling them, we include all of the numbers, borders and ticks.
